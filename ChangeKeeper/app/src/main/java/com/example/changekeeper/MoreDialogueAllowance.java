...
public class MoreDialogueAllowance extends AppCompatDialogFragment{

    private MoreDialogueListener listener;
    private String[] info;
    private String next;

    MoreDialogueAllowance(String[] row, String next){
        this.info = row;
        this.next = next;
    }
    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View view = inflater.inflate(R.layout.layout_more_dialogue_allowance,null);
